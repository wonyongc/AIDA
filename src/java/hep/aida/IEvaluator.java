...
public interface IEvaluator {
   ...
   * @throws      IllegalArgumentException If the IEvaluator and 
   ...
   * @throws RuntimeException if the IEvaluator has not been initialized.
   *
   */ 
    public double evaluateDouble() throws RuntimeException;
